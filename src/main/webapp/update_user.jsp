...
<form action="upprocess.jsp" method="post">
  <div class="mb-3 mt-3">
    <label for="email" class="form-label">Username:</label>
    <input type="text" class="form-control" id="email" placeholder="Enter Username" name="id" value="<%=resultSet.getString("user_id") %>">
  </div>
  <div class="mb-3 mt-3">
    <label for="email" class="form-label">Username:</label>
    <input type="text" class="form-control" id="email" placeholder="Enter Username" name="uname" value="<%=resultSet.getString("username") %>">
  </div>
  <div class="mb-3 mt-3">
    <label for="email" class="form-label">Email:</label>
    <input type="email" class="form-control" id="email" placeholder="Enter email" name="email" value="<%=resultSet.getString("email") %>">
  </div>
  <div class="mb-3">
    <label for="pwd" class="form-label">Password:</label>
    <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pass" value="<%=resultSet.getString("password") %>">
  </div>
  <div class="mb-3">
    <label for="pwd" class="form-label">Category:</label>
    <Select class="form-control" id="pwd" placeholder="Enter password" name="category">
    <option><%=resultSet.getString("password") %></option>
    <option>User</option>
    <option>Admin</option>
    </Select>
  </div>
