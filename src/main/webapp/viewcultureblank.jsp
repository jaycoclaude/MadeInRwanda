...
<button type="submit" class="btn btn-dark">Logout</button>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h5 class="over-title margin-bottom-15">View/<span class="text-bold">Culture</span></h5>
<%
String id = request.getParameter("culture_id");
...
<tbody>
<tr>
<td><%=resultSet.getString("culture_name") %></td>
<td><%=resultSet.getString("date1") %></td>
<td><%=resultSet.getString("category") %></td>

<td><%=resultSet.getString("Details") %></td>
    <td><a href="update_culture.jsp?id=<%=resultSet.getString("culture_id")%>">update</a>|<a href="delete_culture.jsp?id=<%=resultSet.getString("culture_id")%>">Delete</a></td>
</tr>
</tbody>
<%
}
