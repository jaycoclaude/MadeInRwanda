              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="sidebar-item contact-form">
                    ...
                    <div class="content">
                    <h2>Add new a culture art</h2>
                    <form action="Culturesrv" class="was-validated" method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="uname">Name:</label>
    <input type="text" class="form-control" id="uname" placeholder="Enter Fashion name..." name="f_name" required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
  <div class="form-group">
    <label for="pwd">Manufacture date:</label>
    <input type="date" class="form-control" id="pwd" placeholder="Enter the date ..." name="date1" required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
    <div class="form-group">
    <label for="uname">Category:</label>
    <select class="form-control" id="uname" name="fcategory" required>
