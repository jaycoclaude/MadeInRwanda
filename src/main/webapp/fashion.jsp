              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="sidebar-item contact-form">
                    ...
                    <div class="content">
                    <h2>Add A new Fashion</h2>
                    <form action="fashionsrv" class="was-validated" method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="uname">Name:</label>
    <input type="text" class="form-control" id="uname" placeholder="Enter fashion name..." name="fname" required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
  <div class="form-group">
    <label for="pwd">Size:</label>
    <input type="text" class="form-control" id="pwd" placeholder="Enter the size ..." name="size" required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
    <div class="form-group">
