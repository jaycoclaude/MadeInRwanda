...
<button type="submit" class="btn btn-dark">Logout</button>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h5 class="over-title margin-bottom-15">View/<span class="text-bold">Fashion</span></h5>
<%
String id = request.getParameter("fashion_id");
...
String sql ="select * from fashion1";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
 %>
<tbody>
<tr>
<td><%=resultSet.getString("fashion_name") %></td>
<td><%=resultSet.getString("size") %></td>
<td><%=resultSet.getString("category") %></td>

<td><%=resultSet.getString("Details") %></td>
    <td><a href="update_fashion.jsp?id=<%=resultSet.getString("fashion_id")%>">update</a>|<a href="delete_fashion.jsp?id=<%=resultSet.getString("fashion_id")%>">Delete</a></td>
</tr>
</tbody>
<%
}
